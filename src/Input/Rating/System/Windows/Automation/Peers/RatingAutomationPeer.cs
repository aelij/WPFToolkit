...
namespace System.Windows.Automation.Peers
{
    ...
    public sealed class RatingAutomationPeer : ItemsControlAutomationPeer, IValueProvider, ISelectionProvider
    {
        ...
        {
            return Controls.Properties.Resources.RatingAutomationPeer_GetLocalizedControlTypeCore;
        }
        ...
        public void SetValue(string value)
        {
            ...
            else if (double.TryParse(value, out ratingValue))
            {
                ...
                {
                    throw new InvalidOperationException(Controls.Properties.Resources.RatingAutomationPeer_SetValue);
                }
