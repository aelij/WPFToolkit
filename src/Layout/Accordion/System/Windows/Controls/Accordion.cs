...
namespace System.Windows.Controls
{
    ...
    public class Accordion : ItemsControl, IUpdateVisualState
    {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms", MessageId = "Indices",
            Justification = "Framework uses indices.")] public static readonly DependencyProperty
                ...
                if (SelectedIndices.Count(i => i != index && i < Items.Count && Items[i].Equals(item)) == 0)
                {
                    if (_isInSelectedItemsCollectionChanged)
                    {
                        throw new InvalidOperationException(
                            Properties.Resources.Accordion_InvalidManipulationOfSelectionCollections);
                    }
                    SelectedItems.Remove(item);
                }
            }
