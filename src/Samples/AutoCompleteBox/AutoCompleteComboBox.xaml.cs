...
[assembly:
    SuppressMessage("Microsoft.Performance", "CA1823:AvoidUnusedPrivateFields", Scope = "member",
        Target = "System.Windows.Controls.Samples.AutoCompleteComboBox.#ComboToggleButton",
        Justification = "Artifact of using a name inside the custom control template.")]
    ...
    public partial class AutoCompleteComboBox
    {
        ...
        private void OnLoaded(object sender, RoutedEventArgs rea)
        {
            ControlApi.ItemFilter = (prefix, item) =>
            {
                ...
                var pme = item as MemberInfoData;
                if (pme == null)
                {
                    return false;
                }
                return
                    (pme.Name.ToUpper(CultureInfo.InvariantCulture)
                        .Contains(prefix.ToUpper(CultureInfo.InvariantCulture)));
            };
        ...
        private void OnPickerChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                var pair = (KeyValuePair<string, Type>) ControlPicker.SelectedItem;
        ...
        {
            var mim = ControlApi.SelectedItem as MemberInfoData;
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode",
            Justification = "Wired up in markup.")]
