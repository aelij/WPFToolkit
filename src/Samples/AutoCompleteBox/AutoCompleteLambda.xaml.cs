...
namespace System.Windows.Controls.Samples
{
    ...
    public partial class AutoCompleteLambda
    {
        /// <summary>
        ...
        {
            var d = (Airport) DepartureAirport.SelectedItem;
            var a = (Airport) ArrivalAirport.SelectedItem;
            var dd = (DateTime) DepartureDate.SelectedDate;
            var ad = (DateTime) ArrivalDate.SelectedDate;
            var p = (int) Passengers.Value;

            Uri travel = WebServiceHelper.CreateAirfareSearchUri(d, a, dd, ad, p);
#if SILVERLIGHT
            HtmlPage.Window.Navigate(travel, "_new");
#else
            Process.Start(travel.ToString());
#endif
        }
