...
namespace System.Windows.Controls.Samples
{
    ...
    public static class WebServiceHelper
    {
        ...
        /// </summary>
        private const string AirfareSearchUriFormat =
            "http://www.bing.com/travel/flight/flightSearch?t=r&o={0}&e={1}&d1={2}&r1={3}&p={4}&b=COACH";
        ...
        {
            return
                new Uri(string.Format(CultureInfo.InvariantCulture, WebSearchUriFormat,
        ...
        {
            return
                new Uri(string.Format(CultureInfo.InvariantCulture, SearchSuggestionsJsonUriFormat,
                    HttpUtility.UrlEncode(searchText)));
        }
        ...
        public static Uri CreateAirfareSearchUri(Airport departureAirport, Airport arrivalAirport, DateTime departure,
            DateTime arrival, int persons)
        {
            return
                new Uri(string.Format(CultureInfo.InvariantCulture, AirfareSearchUriFormat, departureAirport.CodeFaa,
                    arrivalAirport.CodeFaa, HttpUtility.UrlEncode(departure.ToShortDateString()),
                    HttpUtility.UrlEncode(arrival.ToShortDateString()), persons.ToString(CultureInfo.InvariantCulture)));
        }
    }
}