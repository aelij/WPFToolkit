...
namespace System.Windows.Controls.Layout.Design
{
    ...
    internal class AccordionItemDefaultInitializer : DefaultInitializer
    {
        ...
        public override void InitializeDefaults(ModelItem item)
        {
            ...
            string headerName =
                Extensions.GetMemberName<Silverlight::System.Windows.Controls.AccordionItem>(x => x.Header);
            string contentName =
                Extensions.GetMemberName<Silverlight::System.Windows.Controls.AccordionItem>(x => x.Content);
