...
namespace System.Windows.Controls.DataVisualization.Design
{
    ...
    internal class ChartDefaultInitializer : DefaultInitializer
    {
        ...
        public override void InitializeDefaults(ModelItem item)
        {
            ...
            var defaultItemsSource = new SSWM.PointCollection();
            for (int i = 1; i <= 4; i++)
            {
                defaultItemsSource.Add(new Point(i, 10*i));
            }
            ...
            columnSeries.Properties[propertyName].SetValue(ModelFactory.CreateItem(columnSeries.Context,
                typeof (SSWD.Binding)));
