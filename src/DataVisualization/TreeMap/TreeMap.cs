...
namespace System.Windows.Controls.DataVisualization
{
    ...
    public class TreeMap : Control
    {
        ...
        {
            get { return GetValue(InterpolatorValueProperty); }
        ...
        /// </summary>
        private readonly BindingExtractor _helper;
        ...
        private static void OnItemDefinitionSelectorPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            var treeMap = d as TreeMap;
            if (treeMap != null)
            {
                var oldValue = e.OldValue as TreeMapItemDefinitionSelector;
                var newValue = e.NewValue as TreeMapItemDefinitionSelector;
        ...
        protected virtual void OnItemDefinitionSelectorPropertyChanged(TreeMapItemDefinitionSelector oldValue,
        ...
        private static void OnItemDefinitionPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (treeMap != null)
            {
                var oldValue = e.OldValue as TreeMapItemDefinition;
                var newValue = e.NewValue as TreeMapItemDefinition;
        ...
        protected virtual void OnItemDefinitionPropertyChanged(TreeMapItemDefinition oldValue,
        ...
        private static void OnInterpolatorsPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (treeMap != null)
            {
                var oldValue = e.OldValue as Collection<Interpolator>;
                var newValue = e.NewValue as Collection<Interpolator>;
        ...
        protected virtual void OnInterpolatorsPropertyChanged(Collection<Interpolator> oldValue,
            Collection<Interpolator> newValue)
        {
            RebuildTree();
        }
        ...
        public TreeMap()
        {
            ...
            (Interpolators as ObservableCollection<Interpolator>).CollectionChanged +=
                OnInterpolatorsCollectionChanged;
        }
        ...
        private IEnumerable<TreeMapNode> GetTreeMapNodes()
        {
            ...
            {
                // Create a new list
                var allNodes = new List<TreeMapNode>();

                // Seed the queue with the roots
                var nodes = new Queue<TreeMapNode>();
        ...
        {
            var retList = new List<TreeMapNode>();
            ...
            foreach (object root in nodes)
            {
                ...
                if (template.ValueBinding != null)
                {
                    ...
                    var objectChildrenINotifyCollectionChanged = objectChildren as INotifyCollectionChanged;
                    if (objectChildrenINotifyCollectionChanged != null)
                    {
                        // Use a WeakEventListener so that the backwards reference doesn't keep this object alive
                        weakEventListener =
                            new WeakEventListener<TreeMap, object, NotifyCollectionChangedEventArgs>(this);
                        weakEventListener.OnEventAction =
                            (instance, source, eventArgs) => instance.ItemsSourceCollectionChanged(source, eventArgs);
                        weakEventListener.OnDetachAction =
                            wel => objectChildrenINotifyCollectionChanged.CollectionChanged -= wel.OnEvent;
                    ...
                    {
                        var value = _helper.RetrieveProperty(root, template.ValueBinding) as IConvertible;
                        if (value == null)
                        {
            ...
            foreach (TreeMapNode current in GetTreeMapNodes())
            {
                ...
                if (element != null)
                {
                    ...
                    foreach (Interpolator interpolator in Interpolators)
                    {
                        ...
                        {
                            var target = element.FindName(interpolator.TargetName) as DependencyObject;
                            if (target != null)
                            {
                                SetBinding(
                                    InterpolatorValueProperty,
                                    new Binding(interpolator.TargetProperty)
                                    {
                                        Source = target,
                                ...
                                InterpolatorValue =
                                    interpolator.Interpolate(value.ToDouble(CultureInfo.InvariantCulture));
                            }
                        }
                    }
        ...
        private void RebuildTree()
        {
            if (ContainerElement != null)
            {
                ...
                foreach (Interpolator interpolator in Interpolators)
                {
                    ...
                    interpolator.DataContext = DataContext;
                }
