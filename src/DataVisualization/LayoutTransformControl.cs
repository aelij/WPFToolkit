...
namespace System.Windows.Controls.DataVisualization
{
    ...
    // things.
            ...
            const string templateXaml = @"<ControlTemplate TargetType='Control' " +
        ...
        ///     The transform to use to determine the
        ///     matrix.
        /// </param>
        ...
        /// </summary>
        /// <param name="transform">
        ///     The transform to create a matrix for.
        /// </param>
        ...
        private Matrix GetTransformMatrix(Transform transform)
        {
            if (null != transform)
            {
                ...
                {
                    return transformGroup.Children.Aggregate(Matrix.Identity,
                        (current, child) => MatrixMultiply(current, GetTransformMatrix(child)));
                }
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            var measureSize = _childActualSize == Size.Empty
                ? ComputeLargestTransformedSize(availableSize)
                : _childActualSize;
            ...
            Rect transformedDesiredRect =
                RectTransform(new Rect(0, 0, _layoutRoot.DesiredSize.Width, _layoutRoot.DesiredSize.Height),
                    _transformation);
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            Rect transformedRect = RectTransform(
                new Rect(0, 0, finalSizeTransformed.Width, finalSizeTransformed.Height), _transformation);
        ...
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity",
            Justification = "Closely corresponds to WPF's FrameworkElement.FindMaximalAreaLocalSpaceRect.")]
        ...
        /// <returns>
        ///     A value indicating whether the left size is smaller than
        ///     the right.
        /// </returns>
        ...
        /// <param name="decimalsAfterRound">
        ///     The number of decimals after the
        ///     round.
        /// </param>
