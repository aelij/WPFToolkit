...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    internal class ResourceDictionaryDispenser : IResourceDictionaryDispenser
    {
        ...
        /// </summary>
        private readonly LinkedList<ResourceDictionaryDispensedEventArgs> _resourceDictionariesDispensed =
            new LinkedList<ResourceDictionaryDispensedEventArgs>();

        /// <summary>
        ///     A bag of weak references to connected style enumerators.
        /// </summary>
        private readonly WeakReferenceBag<ResourceDictionaryEnumerator> _resourceDictionaryEnumerators =
            new WeakReferenceBag<ResourceDictionaryEnumerator>();
        ...
        public IList<ResourceDictionary> ResourceDictionaries
        {
            ...
            set
            {
                ...
                {
                    {
                        var notifyCollectionChanged = _resourceDictionaries as INotifyCollectionChanged;
        ...
        private void ResourceDictionariesCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (
                !(e.Action == NotifyCollectionChangedAction.Add &&
                  (ResourceDictionaries.Count - e.NewItems.Count) == e.NewStartingIndex))
            {
                Reset();
            }
        }
        ...
        public IResourceDictionaryDispenser Parent
        {
            ...
            set
            {
                if (_parent != value)
                {
                    if (null != _parent)
                    {
                        _parent.ResourceDictionariesChanged -= ParentResourceDictionariesChanged;
                    }
                    _parent = value;
                    if (null != _parent)
                    {
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope",
            Justification = "Returning a usable enumerator instance.")]
        public IEnumerator<ResourceDictionary> GetResourceDictionariesWhere(Func<ResourceDictionary, bool> predicate)
        {
            var enumerator = new ResourceDictionaryEnumerator(this, predicate);
