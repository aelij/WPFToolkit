...
namespace System.Windows.Controls.DataVisualization.Charting
{
        ...
        where T : DataPoint, new()
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1000:DoNotDeclareStaticMembersOnGenericTypes",
            Justification = "This member is necessary because child classes need to share this dependency property.")] public static readonly DependencyProperty DependentRangeAxisProperty =
        ...
        {
            var source = (ColumnBarBaseSeries<T>) d;
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Design", "CA1000:DoNotDeclareStaticMembersOnGenericTypes",
            Justification = "This member is necessary because child classes need to share this dependency property.")] public static readonly DependencyProperty IndependentAxisProperty =
                DependencyProperty.Register(
                    "IndependentAxis",
                    typeof (IAxis),
                    typeof (ColumnBarBaseSeries<T>),
        ...
        /// </summary>
        /// <param name="category">
        ///     The category for which to return the data
        ///     point group.
        /// </param>
        ...
        /// <returns>
        ///     A value indicating whether a data point corresponding to
        ///     a category is grouped.
        /// </returns>
        ...
        protected void RedrawOtherSeries(ISeriesHost seriesHost)
        {
            ...
            foreach (
                ColumnBarBaseSeries<T> series in
                    seriesHost.Series.Where(series => thisType.IsAssignableFrom(series.GetType()))
                        .OfType<ColumnBarBaseSeries<T>>()
                        .Where(series => series != this))
            {
        ...
        protected void CalculateDataPointLength()
        {
            if (!(ActualIndependentAxis is ICategoryAxis))
            {
                IEnumerable<UnitValue> values =
                    ActiveDataPoints
                        .Select(
                            dataPoint => ActualIndependentAxis.GetPlotAreaCoordinate(dataPoint.ActualIndependentValue))
