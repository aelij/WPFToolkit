...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    public abstract class DataPointSingleSeriesWithAxes : DataPointSeriesWithAxes, IRequireGlobalSeriesIndex
    {
        ...
        {
            var source = (DataPointSingleSeriesWithAxes) d;
        ...
        /// <param name="oldValue">Old value.</param>
        /// <param name="newValue">New value.</param>
        [SuppressMessage("Microsoft.Usage", "CA2233:OperationsShouldNotOverflow", MessageId = "newValue+1",
            Justification = "Impractical to add as many Series as it would take to overflow.")]
        protected virtual void OnGlobalSeriesIndexPropertyChanged(int? oldValue, int? newValue)
        {
            ...
            {
                Title = newValue.HasValue
                    ? string.Format(CultureInfo.CurrentCulture,
                        Properties.Resources.Series_OnGlobalSeriesIndexPropertyChanged_UntitledSeriesFormatString,
                        newValue.Value + 1)
                    : null;
        ...
        [SuppressMessage("Microsoft.Design", "CA1024:UsePropertiesWhereAppropriate",
            Justification = "This property does more work than get functions typically do.")]
        ...
        private void CreateLegendItemDataPoint()
        {
            ...
            dataPoint.SetBinding(StyleProperty, new Binding(ActualDataPointStyleName) {Source = this});
