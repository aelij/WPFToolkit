...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    [SuppressMessage("Microsoft.Maintainability", "CA1501:AvoidExcessiveInheritance",
        Justification = "Depth of hierarchy is necessary to avoid code duplication.")]
    ...
    public class ColumnSeries : ColumnBarBaseSeries<ColumnDataPoint>
    {
        ...
        protected override void GetAxes(DataPoint firstDataPoint)
        {
            GetAxes(
                ...
                axis =>
                {
                    var rangeAxis = axis as IRangeAxis;
                ...
                () =>
                {
                    ...
                    var axis = rangeAxis as DisplayAxis;
                    if (axis != null)
                    {
        ...
        protected override void UpdateDataPoint(DataPoint dataPoint)
        {
            ...
            object category = dataPoint.ActualIndependentValue ?? (ActiveDataPoints.IndexOf(dataPoint) + 1);
            ...
            {
                throw new InvalidOperationException(
                    Properties.Resources.DataPointSeriesWithAxes_ThisSeriesDoesNotSupportRadialAxes);
            }
            ...
            IEnumerable<ColumnSeries> columnSeries =
                SeriesHost.Series.OfType<ColumnSeries>()
                    .Where(series => series.ActualIndependentAxis == ActualIndependentAxis);
            ...
            double dataPointY =
                ActualDependentRangeAxis.GetPlotAreaCoordinate(ValueHelper.ToDouble(dataPoint.ActualDependentValue))
                    .Value;
            ...
            if (GetIsDataPointGrouped(category))
            {
                ...
                columnWidth *= 0.8;
                Panel.SetZIndex(dataPoint, -index);
            }
