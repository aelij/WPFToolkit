...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    public class PieSeries : DataPointSeries, IResourceDictionaryDispenser, IRequireGlobalSeriesIndex
    {
        ...
        {
            var source = d as PieSeries;
            var newValue = e.NewValue as Collection<ResourceDictionary>;
        ...
        /// </summary>
        private readonly Dictionary<DataPoint, LegendItem> _dataPointLegendItems =
            new Dictionary<DataPoint, LegendItem>();
        ...
        protected override void AddDataPoint(DataPoint dataPoint)
        {
            ...
            pieDataPoint.SetBinding(StyleProperty,
                new Binding(PieDataPoint.ActualDataPointStyleName) {Source = pieDataPoint});
            pieDataPoint.ActualLegendItemStyle = LegendItemStyle ??
                                                 (pieDataPoint.Resources[LegendItemStyleName] as Style);
            legendItem.SetBinding(StyleProperty, new Binding(ActualLegendItemStyleName) {Source = pieDataPoint});
        ...
        {
            double sum =
                ActivePieDataPoints.Select(pieDataPoint => Math.Abs(ValueHelper.ToDouble(pieDataPoint.DependentValue)))
                    .Sum();
        ...
        protected virtual LegendItem CreatePieLegendItem(DataPoint dataPoint, int index)
        {
            ...
            legendDataPoint.SetBinding(StyleProperty,
                new Binding(PieDataPoint.ActualDataPointStyleName) {Source = dataPoint});
        ...
        {
            var dataPoint = sender as DataPoint;
            dataPoint.BeginAnimation(PieDataPoint.ActualOffsetRatioProperty, "ActualOffsetRatio", args.NewValue,
        ...
        ///     A predicate that returns a value indicating
