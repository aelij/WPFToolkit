...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    public abstract class DataPointSeries : Series
    {
        ...
        /// </summary>
        private readonly StoryboardQueue _storyBoardQueue = new StoryboardQueue();
        ...
        {
            get { return _dependentValueBinding; }
            set
            {
        ...
        {
            get { return _independentValueBinding; }
            set
            {
        ...
        internal void InvokeOnLayoutUpdated(Action action)
        {
            ...
            handler = delegate
            {
                PlotArea.LayoutUpdated -= handler;
                action();
            };
        ...
        protected virtual void OnItemsSourceCollectionChanged(IEnumerable collection, NotifyCollectionChangedEventArgs e)
        {
            if (e.Action == NotifyCollectionChangedAction.Replace)
            {
                ...
                {
                    DataPoint dataPointToUpdate =
                        _dataPointsByObject[e.OldItems[index]].Where(dp => Equals(e.OldItems[index], dp.DataContext))
                            .Except(updatedDataPoints)
                            .FirstOrDefault();
        ...
        /// <param name="newValue">The new value.</param>
        protected virtual void OnDataPointStateChanged(DataPoint dataPoint, DataPointState oldValue,
        ...
        /// <param name="sender">The data point.</param>
        /// <param name="args">Information about the event.</param>
        private void OnDataPointActualDependentValueChanged(object sender,
            RoutedPropertyChangedEventArgs<IComparable> args)
        {
        ...
        /// <param name="oldValue">The old value.</param>
        /// <param name="newValue">The new value.</param>
        protected virtual void OnDataPointActualDependentValueChanged(DataPoint dataPoint, IComparable oldValue,
        ...
        /// <param name="oldValue">The old value.</param>
        /// <param name="newValue">The new value.</param>
        protected virtual void OnDataPointActualIndependentValueChanged(DataPoint dataPoint, object oldValue,
            object newValue)
        {
        }
        ...
        /// <param name="oldValue">The old value.</param>
        /// <param name="newValue">The new value.</param>
        protected virtual void OnDataPointDependentValueChanged(DataPoint dataPoint, IComparable oldValue,
            IComparable newValue)
        {
        }
        ...
        internal static IEnumerator<ResourceDictionary> GetResourceDictionaryWithTargetType(
            IResourceDictionaryDispenser dispenser, Type targetType, bool takeAncestors)
        {
            return dispenser.GetResourceDictionariesWhere(dictionary =>
            {
                var style = dictionary[DataPointStyleName] as Style;
                if (null != style)
                {
                    return (null != style.TargetType) &&
                           ((targetType == style.TargetType) ||
                            (takeAncestors && style.TargetType.IsAssignableFrom(targetType)));
                }
                return false;
            });
        }
