...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    public abstract class DisplayAxis : Axis, IRequireSeriesHost
    {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly", MessageId = "GridLines",
            Justification = "This is the expected casing.")]
...
Justification = "This is the expected capitalization.")]
        ...
        /// </summary>
        /// <param name="newValue">
        ///     A value indicating whether to display grid
        ///     lines or not.
        /// </param>
        private void SetShowGridLines(bool newValue)
        {
            if (newValue)
            {
                GridLines = new OrientedAxisGridLines(this);
            }
            else
            {
                GridLines = null;
        ...
        static DisplayAxis()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(DisplayAxis),
                new FrameworkPropertyMetadata(typeof(DisplayAxis)));
        }
        ...
        ///     The data context to use for the axis
        ///     label.
        /// </param>
        ...
        private void ArrangeAxisGrid()
        {
            if (AxisGrid != null)
            {
                ...
                if (Orientation == AxisOrientation.Y)
                {
                    OrientedPanel.Orientation = Controls.Orientation.Vertical;
                ...
                {
                    OrientedPanel.Orientation = Controls.Orientation.Horizontal;
        ...
        ///     The available size in which to render
        ///     the axis.
        /// </param>
        ...
        {
            if (oldValue != null && GridLines != null)
            {
                oldValue.BackgroundElements.Remove(GridLines);
            }

            if (newValue != null && GridLines != null)
            {
                newValue.BackgroundElements.Add(GridLines);
            }
        }

        private static readonly DependencyPropertyKey GridLineIndexPropertyKey = DependencyProperty
            .RegisterAttachedReadOnly(
                "GridLineIndex", typeof(int), typeof(DisplayAxis), new FrameworkPropertyMetadata());

        /// <summary>
        ///     Identifies the GridLineIndex attached property.
        /// </summary>
        public static readonly DependencyProperty GridLineIndexProperty = GridLineIndexPropertyKey.DependencyProperty;

        internal static void SetGridLineIndex(DependencyObject element, int value)
        {
            element.SetValue(GridLineIndexPropertyKey, value);
        }

        /// <summary>
        ///     Gets the grid line index.
        /// </summary>
        /// <param name="element"></param>
        /// <returns></returns>
        public static int GetGridLineIndex(DependencyObject element)
        {
            return (int)element.GetValue(GridLineIndexProperty);
        }
    }
}