...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    public class DateTimeAxisLabel : AxisLabel
    {
        ...
        {
            var source = (DateTimeAxisLabel) d;
            var oldValue = (DateTimeIntervalType) e.OldValue;
            var newValue = (DateTimeIntervalType) e.NewValue;
        ...
        protected virtual void OnIntervalTypePropertyChanged(DateTimeIntervalType oldValue,
        ...
        /// <param name="e">Event arguments.</param>
        private static void OnYearsIntervalStringFormatPropertyChanged(DependencyObject d,
        ...
        /// <param name="e">Event arguments.</param>
        private static void OnMonthsIntervalStringFormatPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            var source = (DateTimeAxisLabel) d;
        ...
        /// <param name="e">Event arguments.</param>
        private static void OnWeeksIntervalStringFormatPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            var source = (DateTimeAxisLabel) d;
        ...
        /// <param name="e">Event arguments.</param>
        private static void OnDaysIntervalStringFormatPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            var source = (DateTimeAxisLabel) d;
        ...
        /// <param name="e">Event arguments.</param>
        private static void OnHoursIntervalStringFormatPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            var source = (DateTimeAxisLabel) d;
        ...
        /// <param name="e">Event arguments.</param>
        private static void OnMinutesIntervalStringFormatPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            var source = (DateTimeAxisLabel) d;
        ...
        /// <param name="e">Event arguments.</param>
        private static void OnSecondsIntervalStringFormatPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            var source = (DateTimeAxisLabel) d;
        ...
        /// <param name="e">Event arguments.</param>
        private static void OnMillisecondsIntervalStringFormatPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            var source = (DateTimeAxisLabel) d;
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof (DateTimeAxisLabel),
                new FrameworkPropertyMetadata(typeof (DateTimeAxisLabel)));
        }
        ...
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity",
            Justification = "Code is not overly complex.")]
            ...
            if (StringFormat == null)
            {
                switch (IntervalType)
                {
                    case DateTimeIntervalType.Years:
                        SetBinding(FormattedContentProperty,
                            new Binding
                            {
                                Converter = new StringFormatConverter(),
                                ConverterParameter = YearsIntervalStringFormat ?? StringFormat ?? "{0}"
                            });
                        break;
                    case DateTimeIntervalType.Months:
                        SetBinding(FormattedContentProperty,
                            ...
                            {
                                Converter = new StringFormatConverter(),
                                ConverterParameter = MonthsIntervalStringFormat ?? StringFormat ?? "{0}"
                            });
                        break;
                    case DateTimeIntervalType.Weeks:
                        SetBinding(FormattedContentProperty,
                            ...
                            {
                                Converter = new StringFormatConverter(),
                                ConverterParameter = WeeksIntervalStringFormat ?? StringFormat ?? "{0}"
                            });
                        break;
                    case DateTimeIntervalType.Days:
                        SetBinding(FormattedContentProperty,
                            ...
                            {
                                Converter = new StringFormatConverter(),
                                ConverterParameter = DaysIntervalStringFormat ?? StringFormat ?? "{0}"
                            });
                        break;
                    case DateTimeIntervalType.Hours:
                        SetBinding(FormattedContentProperty,
                            ...
                            {
                                Converter = new StringFormatConverter(),
                                ConverterParameter = HoursIntervalStringFormat ?? StringFormat ?? "{0}"
                            });
                        break;
                    case DateTimeIntervalType.Minutes:
                        SetBinding(FormattedContentProperty,
                            ...
                            {
                                Converter = new StringFormatConverter(),
                                ConverterParameter = MinutesIntervalStringFormat ?? StringFormat ?? "{0}"
                            });
                        break;
                    case DateTimeIntervalType.Seconds:
                        SetBinding(FormattedContentProperty,
                            ...
                            {
                                Converter = new StringFormatConverter(),
                                ConverterParameter = SecondsIntervalStringFormat ?? StringFormat ?? "{0}"
                            });
                        break;
                    case DateTimeIntervalType.Milliseconds:
                        SetBinding(FormattedContentProperty,
                            ...
                            {
                                Converter = new StringFormatConverter(),
                                ConverterParameter = MillisecondsIntervalStringFormat ?? StringFormat ?? "{0}"
                            });
                        break;
                    default:
