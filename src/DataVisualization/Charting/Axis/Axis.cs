...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    public abstract class Axis : Control, IAxis
    {
        ...
        {
            var source = (Axis) d;
            var oldValue = (AxisLocation) e.OldValue;
            var newValue = (AxisLocation) e.NewValue;
        ...
        {
            RoutedPropertyChangedEventHandler<AxisLocation> handler = LocationChanged;
            if (handler != null)
            {
        ...
        {
            var source = (Axis) d;
            var oldValue = (AxisOrientation) e.OldValue;
            var newValue = (AxisOrientation) e.NewValue;
        ...
        protected Axis()
        {
            ...
            RegisteredListeners.CollectionChanged += RegisteredListenersCollectionChanged;
            DependentAxes = new ObservableCollection<IAxis>();
            DependentAxes.CollectionChanged += OnChildAxesCollectionChanged;
        }
