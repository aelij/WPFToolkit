...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    internal class ResourceDictionaryEnumerator : IEnumerator<ResourceDictionary>
    {
        ...
        {
            if (ResourceDictionaryDispenser.ResourceDictionaries == null ||
                ResourceDictionaryDispenser.ResourceDictionaries.Count == 0)
            {
                return new int?();
            }
        ...
        internal void ResourceDictionaryDispenserResourceDictionaryDispensed(object sender,
            ResourceDictionaryDispensedEventArgs e)
        {
        ...
        {
            get { return ResourceDictionaryDispenser.ResourceDictionaries == null; }
        }
        ...
        public void Reset()
        {
            throw new NotSupportedException(
                Properties.Resources.ResourceDictionaryEnumerator_CantResetEnumeratorResetDispenserInstead);
        }
