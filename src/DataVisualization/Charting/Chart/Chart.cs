...
namespace System.Windows.Controls.DataVisualization.Charting
{
    ...
    public class Chart : Control, ISeriesHost
    {
        ...
        /// </summary>
        private readonly ObservableCollectionListAdapter<UIElement> _chartAreaChildrenListAdapter =
            new ObservableCollectionListAdapter<UIElement>();
        ...
        {
            get { return _axes; }
            set { throw new NotSupportedException(Properties.Resources.Chart_Axes_SetterNotSupported); }
        }
        ...
        /// </summary>
        private readonly ObservableCollection<UIElement> _foregroundElements =
            new NoResetObservableCollection<UIElement>();

        /// <summary>
        ///     The collection of background elements.
        /// </summary>
        private readonly ObservableCollection<UIElement> _backgroundElements =
            new NoResetObservableCollection<UIElement>();
        ...
        /// </summary>
        /// <param name="d">
        ///     Chart that contains the changed Palette.
        /// </param>
        ...
        {
            var requiresSeriesHost = axis as IRequireSeriesHost;
        ...
        private void AxisLocationChanged(object sender, RoutedPropertyChangedEventArgs<AxisLocation> args)
        {
            ...
            if (args.NewValue == AxisLocation.Auto)
            {
                throw new InvalidOperationException(
                    Properties.Resources.Chart_AxisLocationChanged_CantBeChangedToAutoWhenHostedInsideOfASeriesHost);
            }
        ...
        /// </summary>
        /// <param name="series">
        ///     The series to remove from the plot area.
        /// </param>
        ...
        private void SeriesCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (null != e.OldItems)
            {
                foreach (ISeries series in e.OldItems)
                {
                    ...
                    var require = series as IRequireGlobalSeriesIndex;
                    if (require != null)
                    {
