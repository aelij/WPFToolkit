...
namespace System.Windows.Controls.DataVisualization.Collections
{
    ...
    internal class LeftLeaningRedBlackTree<TKey, TValue>
    {
        ...
        /// </summary>
        private readonly Comparison<TValue> _valueComparison;
    ...
    /// </summary>
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly", MessageId = "GetValueForKey",
            Justification = "Method name.")]
