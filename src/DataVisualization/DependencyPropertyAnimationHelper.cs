...
namespace System.Windows.Controls.DataVisualization
{
    ...
    internal static class DependencyPropertyAnimationHelper
    {
        ...
        ///     The property path of the property that
        ///     the storyboard animates.
        /// </param>
        ...
        /// <param name="animatingDependencyProperty">
        ///     The dependency property to
        ///     animate.
        /// </param>
        /// <param name="propertyPath">
        ///     The path of the dependency property to
        ///     animate.
        /// </param>
        /// <param name="targetValue">
        ///     The value to animate the dependency
        ///     property to.
        /// </param>
        /// <param name="timeSpan">The duration of the animation.</param>
        /// <param name="easingFunction">
        ///     The easing function to uses to
        ///     transition the data points.
        /// </param>
        ...
        {
            var storyBoard = target.Resources[GetStoryboardKey(propertyPath)] as Storyboard;
    ...
    // Restore that value so it doesn't snap back to its starting value
        ...
        /// </summary>
        /// <param name="target">
        ///     The element that is the target of the
        ///     storyboard.
        /// </param>
        /// <param name="animatingDependencyProperty">
        ...
        /// </param>
        /// <param name="propertyPath">
        ///     The property path of the dependency
        ///     property to animate.
        /// </param>
        /// <param name="toValue">
        ///     The value to animate the dependency property
        ///     to.
        /// </param>
        ...
        /// </param>
        /// <param name="easingFunction">
        ///     The easing function to use to
        ///     transition the data points.
        /// </param>
        /// <returns>The story board that animates the property.</returns>
        [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "easingFunction",
            Justification = "This parameter is used in Silverlight.")]
            ...
            IEasingFunction easingFunction)
        {
                         ...
                         ValueHelper.TryConvert(toValue, out toDateTime))
                {
                    ...
                    IEnumerable<DiscreteObjectKeyFrame> keyFrames =
                        EnumerableFunctions.Zip(
                            ...
                            timeSpanIntervals,
                            (dateTime, timeSpan) =>
                                new DiscreteObjectKeyFrame {Value = dateTime, KeyTime = timeSpan});
            ...
            {
                var keyFrameAnimation = new ObjectAnimationUsingKeyFrames();
                var endFrame = new DiscreteObjectKeyFrame {Value = toValue, KeyTime = new TimeSpan(0, 0, 0)};
